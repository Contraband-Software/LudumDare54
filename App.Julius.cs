...
public class App_Julius : Game
{
    ...
    protected override void Initialize() {
        ...
        //engine.AddLight(new Vector2(100, 100), new Vector3(10000, 10000, 10000));

        Texture2D colortex = Content.Load<Texture2D>("Sprites/image");
        Texture2D normaltex = Content.Load<Texture2D>("Sprites/normal");

        engine.addSprite(new LeviathanSprite(this, Matrix.CreateTranslation(new Vector3(-50, -50, 0)), new Point(500), colortex, normaltex,false));
        engine.addSprite(new LeviathanSprite(this, Matrix.CreateTranslation(new Vector3(450, -50, 0)), new Point(500), colortex, normaltex, false));
        engine.addSprite(new LeviathanSprite(this, Matrix.CreateTranslation(new Vector3(200, 200, 0)), new Point(100), colortex, normaltex));
